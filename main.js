...
var ModalsComponent = /** @class */ (function () {
    ...
    ModalsComponent.prototype.open = function (content, options) {
        ...
        var contentBody = modalRef['_contentRef'].nodes[0][1];
